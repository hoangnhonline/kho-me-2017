...
<div>
	<div>
		<h3>法音: <?php echo (isset($_GET['idPA']) ? "回復更新" : "新加")?></h3>
    </div>    
    <div class="clr"></div>
</div>
<div id="main_admin">
	...
	<div id="main_left">    	
            	<table>     
                    ...
                    <tr class="left">
                        ...
                        <td width="181"><input type="text" name="File" id="File" class="tf" value="<?php echo isset($row_ct['File']) ? $row_ct['File'] : ""; ?>" style="width: 400px;height: 25px"  />
                        	<span class="error"><?php echo isset($loi['File']) ? $loi['File'] : "";?></span>
                        </td>                        
                    </tr>            
                </table>
