                        ...
                        <td >
                            <select name='idML' id="idML">
                                ...
                                while ($row = mysql_fetch_assoc($MucLuc)) {
                                    ?>
                                    <option <?php if (isset($row_ct['idML']) && $row_ct['idML'] == $row['idML']) echo "selected"; ?> value='<?php echo $row['idML'] ?>'><?php echo $row['TenMucLuc']; ?></option>
<?php } ?>
                            </select>
                        </td>
                    </tr>
...
while ($row = mysql_fetch_assoc($sachss)) {
    ?>
                                    <option <?php if (isset($row_ct['idSach']) && $row_ct['idSach'] == $row['idSach']) echo "selected"; ?> value='<?php echo $row['idSach'] ?>'><?php echo $row['TenSach']; ?></option>
<?php } ?>
                            </select>
                        </td>
                    </tr>
...
while ($row = mysql_fetch_assoc($sachs)) {
    ?>
                                        <option <?php if (isset($_GET['idSachs']) && $_GET['idSachs'] == $row['idSach']) echo "selected=selected"; ?> value='<?php echo $row['idSach'] ?>'><?php echo $row['TenSach']; ?></option>
<?php } ?>
                                </select>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
