...
(function()
{
	...
	// contents.
	// V2
	var execContents移動 = function( range, action, docFrag, mergeThen )
	{
	...
	CKEDITOR.dom.range.prototype =
	{
		...
		deleteContents : function( mergeThen )
		{
			...
			execContents移動( this, 0, null, mergeThen );
		},
		...
		extractContents : function( mergeThen )
		{
			...
			if ( !this.collapsed )
				execContents移動( this, 1, docFrag, mergeThen );
