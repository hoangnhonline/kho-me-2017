<?php
	...
	}else 
	{
		...
		$manager = new manager();
		$manager->setSession移動($session移動);
...
<script type="text/javascript">
	...
	var action = '<?php echo $session移動->get移動(); ?>';
	var numFiles = <?php echo $session移動->count(); ?>;
...
<form action="" method="POST" name="form移動" id="form移動"><input type="hidden" name="currentFolderPath" id="currentFolderPathVal" value="" /><select name="selectedDoc[]" id="selectedDoc" style="display:none;" multiple="multiple"></select><input type="hidden" name="action_value" value="" id="action_value" /></form>				  
    </div>
