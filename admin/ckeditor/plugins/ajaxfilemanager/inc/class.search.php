<?php
	...
	class Search
	{
		...
		function __construct($rootFolder)
		{
			...
			$selectedDocuments = $this->session移動->get();					
			...
			$tem['flag'] = (array_search($tem['path'], $selectedDocuments) !== false?($this->session移動->get移動() == "copy"?'copyFlag':'cutFlag'):'noFlag');
