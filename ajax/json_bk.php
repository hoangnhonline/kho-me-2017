...
$strPhanTrang = '<div id="pagination">';
    ...
    for($i=$dau; $i<$cuoi; $i++){ 
            if($i == $idTrang){$class = "selected";

            $strPhanTrang.='<a  href="javascript:void(0)">
                    <span class="pagination_h selected" idML='.$idML.' idTrang='.$i.'>'.$i.'</span></a>';
}else {
$strPhanTrang.='<a href="javascript:void(0)">
                    <span class="pagination_h" idML='.$idML.' idTrang='.$i.'>'.$i.'</span></a>';
} 
} 
$strPhanTrang.='</div>';
}
